...
setup(
    ...
    entry_points={
        'console_scripts': [
            'run_main = hiwin_example.first_version:main',
            ...
            'io_test = hiwin_example.io_test:main',
            'long_version=hiwin_example.long_version:main',
            'test=hiwin_example.test:main',
            'senior_node=hiwin_example.senior_node:main',
            'fake_senior=hiwin_example.fake_senior:main',
        ],
    },
)
